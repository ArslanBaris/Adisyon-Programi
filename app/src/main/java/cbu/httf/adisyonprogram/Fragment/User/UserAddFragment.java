...
public class UserAddFragment extends BottomSheetDialogFragment {
    ...
    public UserAddFragment(String token) {
        this.token=token;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        editTextUserName=(EditText)view.findViewById(R.id.editTextAddUsername);
        ...
        imgClose = view.findViewById(R.id.add_user_imgClose);
        ...
        postUser = (Button)view.findViewById(R.id.postUser);
